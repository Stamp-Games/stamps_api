...
from flaskapp import session, Stamp, Question, app
...
def seed():
    ...
    session.add(q1)
    q2 = Question(category="US Presidents", 
    ...
    q3 = Question(category="US Presidents", 
    ...
    q4 = Question(category="US Presidents", 
    ...
    q5 = Question(category="US Presidents", 
    ...
    session.add(q5)
    q6 = Question(category="US Presidents", 
    ...
    session.add(q6)
    q7 = Question(category="US Presidents", 
    ...
    session.add(q7)
    q8 = Question(category="US Presidents", 
    ...
    q9 = Question(category="US Presidents", 
    ...
    q10 = Question(category="US Presidents", 
    ...
    session.add(q10)
    q11 = Question(category="US Presidents", 
    ...
    session.add(q11)
    q12 = Question(category="US Presidents", 
    ...
    q35 = Question(category="Aviation", 
    ...
    q36 = Question(category="Aviation", 
    ...
    session.add(q36)		 		
    q37 = Question(category="Aviation", 
    ...
    session.add(q37)
    q38 = Question(category="Aviation", 
    ...
    session.add(q38)
    q39 = Question(category="Aviation", 
    ...
    q40 = Question(category="Aviation", 
    ...
    q41 = Question(category="Aviation", 
    ...
    session.add(q41)
    q42 = Question(category="Aviation", 
    ...
    q43 = Question(category="Aviation", 
    ...
    q44 = Question(category="Aviation", 
    ...
    q45 = Question(category="Aviation", 
    ...
    session.add(q45)
    q46 = Question(category="Aviation", 
    ...
    session.add(q46)
    q47 = Question(category="Aviation", 
    ...
    session.add(q59)
    q60 = Question(category="Olympics", 
    ...
    q61 = Question(category="Olympics", 
    ...
    q62 = Question(category="Olympics", 
    ...
    q63 = Question(category="Olympics", 
    ...
    q64 = Question(category="Olympics", 
    ...
    q65 = Question(category="Olympics", 
    ...
    q66 = Question(category="Olympics", 
    ...
    q67 = Question(category="Olympics", 
    ...
    q68 = Question(category="Olympics", 
    ...
    q69 = Question(category="Olympics", 
    ...
    q70 = Question(category="Olympics", 
    ...
    q71 = Question(category="Olympics", 
